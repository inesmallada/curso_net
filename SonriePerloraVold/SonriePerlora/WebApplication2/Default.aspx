            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl" href="#">[RE]descubre Perlora </a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm" runat="server" server="perlora.database.windows.net">
                            <!-- Name input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="txtName" type="text" placeholder="Introduce tu nombre..." />
                                <label for="name">Nombre</label>
                            </div>
                               <!-- Apellidos input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="txtSurname" type="text" placeholder="Introduce tus apellidos..." />
                                <label for="surname">Apellidos</label>
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="txtEmail" type="email" placeholder="name@example.com" />
                            ...
                            <!-- Submit Button-->
                             <div class="d-grid">
                               <asp:Button ID="btnAcceso1" runat="server" class="btn btn-primary btn-xl" Text="Regístrate" OnClick="btnAcceso_Click" />
                               <asp:Label ID="lblConfirmacion0" runat="server" Text=""></asp:Label> 
                             </div>
                        </form>
                    </div>
                </div>
