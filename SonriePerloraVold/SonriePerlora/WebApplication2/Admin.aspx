            ...
            <div class="container px-4 px-lg-5 h-100">
                 <div>
                     <form runat="server" id="datosPersonal" server="perlora.database.windows.net">
                            <!-- Usuario input-->
                            <div class="mb-3">
                                <asp:TextBox class="form-control" ID="txtUsuario" placeholder="Introduce usuario..." runat="server"></asp:TextBox>
                            ...
                            <!-- Password input-->
                            <div class="mb-3">
                                <asp:TextBox class="form-control" ID="txtPass" placeholder="Contraseña" runat="server"></asp:TextBox>
                            ...
                            <div class="mb-3">
                                <asp:DropDownList class="form-control" ID="dllTipo" runat="server" DataSourceID="SqlDataSource4" DataTextField="tipo" DataValueField="tipo"></asp:DropDownList>
                                <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:SonriePerloraConnectionString1 %>' SelectCommand="SELECT tipo FROM [Admin]"></asp:SqlDataSource>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Campo Obligatorio" ControlToValidate="dllTipo" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                               <!-- Submit Button-->
                            <div class="d-grid">
